            ...
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>DATA PASIEN TOTAL: {{ items.length }}</strong>
                </h3>
              </b-col>
            </b-row>
              ...
              <b-col lg="12">
                ...
                >
                  ...
                  <template v-slot:cell(actions)="row">
                    ...
                    <router-link :to="'/screeningpasiensiduga/' + row.item.id">
                    ...
                    <b-button
                      size="sm"
                      variant="warning"
                      @click="rubah(row.item, row.index, $event.target)"
                      class="mr-1"
                      >Edit</b-button
                    >
                    <b-button
...
export default {
  ...
  methods: {
    ...
    hapus(id) {
      let vm = this;
      axios
        .delete("http://sideku.org:8801/pasien/delete/" + id, {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
        })
