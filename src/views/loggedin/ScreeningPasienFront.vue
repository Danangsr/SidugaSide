...
export default {
  ...
  mounted() {
    axios
      .get(ip_server + "pasien/front/" + this.$route.params.idPasien)
      .then((data) => {
    ...
    //load master
    axios
      .get(ip_server + "penyakit/historyfront/" + this.$route.params.idPasien)
      .then((data) => {
        this.penyakit = [];
    ...
    axios
      .get(
        ip_server + "gejalafisik/historyfront/" + this.$route.params.idPasien
      )
      .then((data) => {
        this.gejalaFisik = [];
        data.data.respon.forEach((element) => {
    ...
    axios
      .get(
        ip_server + "gejalapsikis/historyfront/" + this.$route.params.idPasien
      )
      .then((data) => {
        this.gejalaPsikis = [];
        data.data.respon.forEach((element) => {
    ...
    axios
      .get(
        ip_server +
          "gejalaperilakuburuk/historyfront/" +
          this.$route.params.idPasien
      )
      .then((data) => {
    ...
    axios
      .get(ip_server + "pernyataan/historyfront/" + this.$route.params.idPasien)
      .then((data) => {
        this.pernyataan = [];
        data.data.respon.forEach((element) => {
          let ob = {
    ...
    axios
      .get(ip_server + "poolfotowajah/pasien/" + this.$route.params.idPasien, {
        headers: {
  ...
  methods: {
    ...
    submitData() {
      ...
      if (vm.emosi != "") {
        axios
          .post(ip_server + "pasien/screeningfront", {
            pasienId: this.$route.params.idPasien,
