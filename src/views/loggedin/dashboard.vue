<template>
  <div id="dashboard">
              ...
              <router-link :to="'gejalaPerilakuBuruk'">
                <center>
                  ...
                  <h6 class="m-t-0 m-b-0">
                    <strong>GEJALA PERILAKU BURUK</strong>
                  </h6>
                </center>
              </router-link>
            </div>
            ...
            <div class="boxmenu">
              ...
              >
                <center>
                  <img
                    src="../../assets/checkup.png"
                    style="height: 100px; border-radius: 100%"
                  />
                  <h5 class="m-t-15 m-b-0"><strong>SCREENING</strong></h5>
                  <h6 class="m-t-0 m-b-0"><strong>PASIEN</strong></h6>
                </center>
    ...
    <b-modal id="modal-1" hide-footer centered title="EXPORT EXCEL">
      ...
      <br />
      Harap membatasi jumlah laporan yang akan anda download maksimal 200 sekali
      download
      <b-form class="bv-example-row">
        <b-row>
          <b-col md="6" lg="6">
            <b-form-group label="Dari">
        ...
        <b-button variant="primary" class="m-t-15" @click="print"
          >Export</b-button
        >
      </b-form>
    </b-modal>
...
export default {
  ...
  mounted() {
    let vm = this;
    axios.get(ip_server + "pasien/count").then((ree) => {
  ...
  methods: {
    ...
    print: function () {
      if (parseInt(this.dari) >= parseInt(this.sampai)) {
        ...
        window.open(
          ip_server + "pasien/print?a=" + this.dari + "&b=" + this.sampai,
          "_blank"
        );
      }
    },
