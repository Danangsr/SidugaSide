...
<template>
  <div id="RiwayatPenyakit">
            ...
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>DATA MASTER RIWAYAT PENYAKIT</strong>
                </h3>
              </b-col>
            </b-row>
              ...
              <b-col md="12">
                <b-breadcrumb>
                  ...
                  <b-breadcrumb-item active
                    >Data Master Riwayat Penyakit</b-breadcrumb-item
                  >
                </b-breadcrumb>
              </b-col>
            </b-row>
                ...
                <b-alert show variant="primary" class="m-b-0">
                  ...
                  >
                    <b-form-checkbox-group v-model="filterOn">
                      <b-form-checkbox value="namaPenyakit"
                        >Nama Penyakit</b-form-checkbox
                      >
    ...
    <b-modal
      ...
      hide-footer
      centered
      title="TAMBAH DATA MASTER RIWAYAT PENYAKIT"
    >
      <b-form class="bv-example-row">
        <b-form-group label="Riwayat Penyakit">
          <b-form-input
...
export default {
  ...
  methods: {
    ...
    edit() {
      ...
      axios
        .patch(
          "http://sideku.org:8801/penyakit/" + this.idChoose,
          {
    ...
    hapus(id) {
      let vm = this;
      axios
        .delete(ip_server + "penyakit/delete/" + id, {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
        })
