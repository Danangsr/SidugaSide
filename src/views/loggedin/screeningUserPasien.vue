            ...
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>SCREENING PASIEN</strong>
                </h3>
              </b-col>
            </b-row>
            <b-row class="m-t-15">
                ...
                <div class="accordion" role="tablist">
                  <b-card no-body class="mb-1">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        "
                        >Riwayat Penyakit -
                        <span>Lama sakit (hari)</span></b-button
                      >
                    </b-card-header>
                    <b-collapse
                      id="accordion-1"
                    ...
                    >
                      <b-card-body>
                        <b-form class="bv-example-row">
                          <b-form-group
                            :label="item.namaPenyakit"
                            v-for="item in penyakit"
                            :key="item.id"
                          >
                            <b-form-input
                              v-model="item.lamaSakit"
                            ></b-form-input>
                          </b-form-group>
                        </b-form>
                      </b-card-body>
                  ...
                  <b-card no-body class="mb-1">
                    ...
                    >
                      <b-card-body>
                        ...
                        <input
                          placeholder="ambil gambar wajah"
                          id="file"
                          ref="file"
                          type="file"
                          accept="image/*"
                        ...
                        >
                          ...
                          <img
                            v-if="urlHasil"
                            :src="
                              'http://sideku.org:8841/hasilprediksi/' + urlHasil
                            "
                            style="width: 100%"
                          />
                        </b-alert>
                  ...
                  <b-card no-body class="mb-1">
                    ...
                    >
                      <b-card-body>
                        ...
                        <h6>
                          <i
                            >Dapat memilih lebih dari satu sesuai dengan apa
                            yang Anda rasakan saat ini</i
                          >
                        </h6>
                        <hr />
                        ...
                        <b-form class="bv-example-row">
                          <b-form-group
                            :label="item.namaGejalaFisik"
                            v-for="item in gejalaFisik"
                            :key="item.id"
                          >
                  ...
                  <b-card no-body class="mb-1">
                    ...
                    >
                      <b-card-body>
                        ...
                        <b-form class="bv-example-row">
                          <b-form-group
                            :label="item.namaGejalaPsikis"
                            v-for="item in gejalaPsikis"
                            :key="item.id"
                          >
                            <b-form-select v-model="item.status">
                              <b-form-select-option value="0"
                  ...
                  <b-card no-body class="mb-1">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        style="
                          ...
                          font-weight: bold;
                        "
                        >Gejala Perilaku Buruk</b-button
                      >
                    </b-card-header>
                    <b-collapse
                      id="accordion-5"
                    ...
                    >
                      <b-card-body>
                        <h5>
                          Perilaku yang berkaitan dengan gangguan emosi dibawah
                          ini
                        </h5>
                        <h6>
                          <i
                            >Boleh memilih lebih dari satu sesuai dengan yang
                            pernah dilakukan</i
                          >
                        </h6>
                        <hr />
                        <b-form class="bv-example-row">
                          <b-form-group
                            :label="item.namaGejalaPerilaku"
                            v-for="item in gejapaPerilakuBuruk"
                            :key="item.id"
                          >
                            <b-form-select v-model="item.status">
                              <b-form-select-option value="0"
                  ...
                  <b-card no-body class="mb-1">
                    <b-card-header header-tag="header" class="p-1" role="tab">
                      <b-button
                        ...
                        style="
                          ...
                          font-weight: bold;
                        "
                        >Kuisioner Regulasi Emosi</b-button
                      >
                    </b-card-header>
                    <b-collapse
                      id="accordion-6"
                    ...
                    >
                      <b-card-body>
                        <b-form class="bv-example-row">
                          <b-form-group
                            :label="item.isiPernyataan"
                            v-for="item in pernyataan"
                            :key="item.id"
                          >
                            <b-form-select v-model="item.status">
                              <b-form-select-option value="1"
...
export default {
  ...
  mounted() {
    axios
      .get(ip_server + "pasien/" + this.$route.params.pasien, {
        headers: {
    ...
    //load master
    axios
      .get(ip_server + "penyakit/history/" + this.$route.params.pasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
      .then((data) => {
        ...
        data.data.respon.forEach((element) => {
          let ob = {
            ...
            pasienId: this.$route.params.pasien,
    ...
    axios
      .get(ip_server + "gejalafisik/history/" + this.$route.params.pasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(ip_server + "gejalapsikis/history/" + this.$route.params.pasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(
        ip_server + "gejalaperilakuburuk/history/" + this.$route.params.pasien,
        {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
    ...
    axios
      .get(ip_server + "pernyataan/history/" + this.$route.params.pasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(ip_server + "poolfotowajah/pasien/" + this.$route.params.pasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
  ...
  methods: {
      ...
      axios
        ...
        .then(function (ress) {
          if (ress.data.nama_file != "") {
            ...
            vm.$swal(
              "Gagal",
              "Tidak ditemukan wajah, coba kembali untuk selfie atau coba dengan mode landscape",
              "error"
            );
          }
        })
    ...
    submitData() {
      ...
      if (vm.emosi != "") {
        ...
        vm.$swal(
          "Gagal",
          "Tidak ada gambar wajah / emosi tidak terdeteksi pada gambar wajah",
          "error"
        );
      }
    },
