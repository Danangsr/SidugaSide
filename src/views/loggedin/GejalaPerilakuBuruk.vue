...
<template>
  <div id="GejalaPerilakuBuruk">
          ...
          <div class="box">
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>DATA MASTER GEJALA PERILAKU BURUK</strong>
                </h3>
              </b-col>
            </b-row>
            <b-row class="m-t-15">
              <b-col md="12">
                <b-breadcrumb>
                  ...
                  <b-breadcrumb-item active
                    >Data Master Gejala Perilaku Buruk</b-breadcrumb-item
                  >
                </b-breadcrumb>
              </b-col>
            </b-row>
            ...
            >
              <b-form class="bv-example-row">
                <b-form-group label="Gejala Perilaku Buruk">
                  <b-form-input
    ...
    <b-modal
      ...
      hide-footer
      centered
      title="TAMBAH DATA MASTER GEJALA PERILAKU BURUK"
    >
      <b-form class="bv-example-row">
        <b-form-group label="Gejala Perilaku Buruk">
          <b-form-input
...
export default {
  ...
  mounted() {
    axios
      .get(ip_server + "gejalaperilakuburuk/all", {
        headers: {
  ...
  methods: {
    ...
    tambah() {
      ...
      axios
        .post(
          ip_server + "gejalaperilakuburuk/register",
          {
    ...
    edit() {
      ...
      axios
        .patch(
          ip_server + "gejalaperilakuburuk/" + this.idChoose,
          {
    ...
    hapus(id) {
      let vm = this;
      axios
        .delete(ip_server + "gejalaperilakuburuk/delete/" + id, {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
        })
