...
export default {
  ...
  mounted() {
    axios
      .get(ip_server + "pasien/" + this.$route.params.idPasien, {
        headers: {
    ...
    //load master
    axios
      .get(ip_server + "penyakit/history/" + this.$route.params.idPasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(ip_server + "gejalafisik/history/" + this.$route.params.idPasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(ip_server + "gejalapsikis/history/" + this.$route.params.idPasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
    ...
    axios
      .get(ip_server + "pernyataan/history/" + this.$route.params.idPasien, {
        headers: {
          accesstoken: localStorage.getItem("token"),
        },
      })
