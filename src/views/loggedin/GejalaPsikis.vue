...
<template>
  <div id="GejalaPsikis">
          ...
          <div class="box">
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>DATA MASTER GEJALA PSIKIS</strong>
                </h3>
              </b-col>
            </b-row>
              ...
              <b-col md="12">
                <b-breadcrumb>
                  ...
                  <b-breadcrumb-item active
                    >Data Master Gejala Psikis</b-breadcrumb-item
                  >
                </b-breadcrumb>
              </b-col>
            </b-row>
            ...
            >
              <b-form class="bv-example-row">
                <b-form-group label="Gejala Psikis">
                  <b-form-input
    ...
    <b-modal
      ...
      hide-footer
      centered
      title="TAMBAH DATA MASTER GEJALA PSIKIS"
    >
      <b-form class="bv-example-row">
        <b-form-group label="Gejala Psikis">
          <b-form-input
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(ip_server + "gejalapsikis/all", {
        headers: {
  ...
  methods: {
    ...
    tambah() {
      ...
      axios
        .post(
          ip_server + "gejalapsikis/register",
          {
    ...
    edit() {
      ...
      axios
        .patch(
          ip_server + "gejalapsikis/" + this.idChoose,
          {
    ...
    hapus(id) {
      let vm = this;
      axios
        .delete(ip_server + "gejalapsikis/delete/" + id, {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
        })
