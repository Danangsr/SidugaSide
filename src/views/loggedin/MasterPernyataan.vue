...
<template>
  <div id="masterPernyataan">
            ...
            <b-row>
              <b-col md="12">
                <h3 class="text-center m-t-0 m-b-0">
                  <strong>DATA MASTER PERNYATAAN</strong>
                </h3>
              </b-col>
            </b-row>
            <b-row class="m-t-15">
              <b-col md="12">
                <b-breadcrumb>
                  ...
                  <b-breadcrumb-item active
                    >Data Master Pernyataan</b-breadcrumb-item
                  >
                </b-breadcrumb>
              </b-col>
            </b-row>
                ...
                <b-alert show variant="primary" class="m-b-0">
                  ...
                  >
                    <b-form-checkbox-group v-model="filterOn">
                      <b-form-checkbox value="isiPernyataan"
                        >Pernyataan</b-form-checkbox
                      >
    ...
    <b-modal
      ...
      hide-footer
      centered
      title="TAMBAH DATA MASTER PERNYATAAN"
    >
      <b-form class="bv-example-row">
        <b-form-group label="Pernyataan">
          <b-form-input
...
export default {
  ...
  methods: {
    ...
    edit() {
      ...
      axios
        .patch(
          ip_server + "pernyataan/" + this.idChoose,
          {
    ...
    hapus(id) {
      let vm = this;
      axios
        .delete(ip_server + "pernyataan/delete/" + id, {
          headers: {
            accesstoken: localStorage.getItem("token"),
          },
        })
