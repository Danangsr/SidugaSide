<template>
  <div>
    ...
    <section id="dukungan-kel-siduga">
      <b-container>
        <b-row>
              ...
              <b-row>
                ...
                <b-col xs="12" sm="12" md="12" lg="12" class="mt-5">
                  <h4 class="text-center">
                    <strong>DUKUNGAN KELUARGA</strong>
                  </h4>
                </b-col>
              </b-row>
                ...
                <b-col xs="12" sm="12" md="12" lg="12">
                  <div class="box-menus">
                    ...
                    >
                      <center>
                        <img
                          src="../assets/Screening Dukungan Keluarga.png"
                          style="width: 140px"
                        />
                        <h4 class="m-t-15 m-b-0">
                          <strong>SCREENING DUKUNGAN</strong>
                        </h4>
                        <h6 class="m-t-0 m-b-0"><strong>KELUARGA</strong></h6>
                      </center>
                    </router-link>
                  </div>
                </b-col>
                ...
                <b-col xs="12" sm="12" md="12" lg="12" class="mt-4">
                  <div class="box-menus">
                    ...
                    >
                      <center>
                        <img
                          src="../assets/Motivasi Spiritual.png"
                          style="width: 140px"
                        />
                  ...
                  <div class="box-menus">
                    ...
                    >
                      <center>
                        ...
                        />
                        <h4 class="m-t-15 m-b-0">
                          <strong>CARA BERKOMUNIKASI</strong>
                        </h4>
...
#dukungan-kel-siduga .box-konten {
  width: 100%;
  min-height: 100vh;
  /* display: flex;
...
#dukungan-kel-siduga .box-konten h1 {
  /* font-size: 48px; */
  font-weight: bold;
}

#dukungan-kel-siduga .box-konten .box-menus {
  width: 80%;
  padding: 30px;
